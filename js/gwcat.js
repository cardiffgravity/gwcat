...
GWCat.prototype.init = function(){
    ...
    this.fileIn = (this.inp && this.inp.fileIn) ? this.inp.fileIn : "https://astrog80.astro.cf.ac.uk/GW/gwosc_gracedb.json";
    this.fileInJsonp = (this.inp && this.inp.fileIn) ? this.inp.fileIn : "https://astrog80.astro.cf.ac.uk/GW/gwosc_gracedb.jsonp";
